---
name: debugger-medium
description: Cost-tier twin of `debugger` (Opus · medium) — identical procedure, return contract and stop list. Dispatch instead of `debugger` when the active mode is `chill`; see modes.json.
model: opus
effort: medium
