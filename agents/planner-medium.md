---
name: planner-medium
description: Cost-tier twin of `planner` (Opus · medium) — identical procedure, return contract and stop list. Dispatch instead of `planner` when the active mode is `chill`; see modes.json.
model: opus
effort: medium
